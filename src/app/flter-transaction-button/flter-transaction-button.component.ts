...
export class FlterTransactionButtonComponent implements OnInit {
  ...
  getFilteredTransactions(): void{
    this.transactionService.getFilteredTransactions(LocationsComponent.selectedLocationID, LanesComponent.selectedLaneID, LaneTypesComponent.selectedLaneTypeID).subscribe(transactions => this.transactionsComponent.transactions);
  }
